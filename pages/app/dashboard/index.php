...
<?php include_once __DIR_BASE__LOCAL__."layouts/e-learning/side-bar-empty.php" ?>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card mt-24">
                        <div class="card-body">
                            ...
                            <h4 class="mb-0">¡Hola <?php echo htmlspecialchars($__USER__['nombre'] ?? ''); ?>! Nos alegra verte de nuevo 😊</h4>
                            </div>
